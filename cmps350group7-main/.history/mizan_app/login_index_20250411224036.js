document.getElementById("loginForm").addEventListener("submit", function (e) {
    ...
    if (matchedUser) {
      ...
      if (role === "student") {
        window.location.href = "students_get_assessment.html";
      } else if (role === "instructor") {
        window.location.href = "instructor_get_assessments.html";
      } else {
        window.location.href = "coordinator_get_assessments.html";
      }
    } else {
