document.addEventListener("DOMContentLoaded", async function() {
    try {
        const response = await fetch("../../mizan-data/courses.json").then(response=>response.json()).then(data=>{console.log(data);data.forEach(course=>{
        ...
        const assessmenttype=await newresponse.json();
